...
>(
  (
    ...
    return (
      <div ref={ref} {...props}>
        {/* <button 
          className="fixed top-4 right-4 z-50 bg-blue-500 text-white p-2 rounded-md md:hidden"
          onClick={() => setOpenMobile(true)}
        >
          <Menu size={24} />
        </button> */}
        {/* Mobile Sheet - Show on small screens */}
        ...
        {/* Desktop Sidebar - Show on medium+ screens */}
        <div
