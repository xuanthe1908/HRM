-- Script tổng hợp để setup hoàn chỉnh expense mapping
...
-- Bước 5: Tạo function để lấy thông tin mapping (sử dụng tên cột đúng)
...
-- Bước 6: Tạo view để dễ dàng truy vấn thông tin liên kết (sử dụng tên cột đúng)
